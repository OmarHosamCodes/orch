...
type OrchTopbarTriggerButtonProps = {
  mood: EclipseMood;
  compactOpen: boolean;
  expanded: boolean;
  badgeCount: number;
...
export const OrchTopbarTriggerButton = forwardRef<HTMLButtonElement, OrchTopbarTriggerButtonProps>(
  function OrchTopbarTriggerButton(
    ...
    const metal = METAL_BY_MOOD[mood];
    return (
      <MetalFx
        ref={metalRef}
        variant="circle"
