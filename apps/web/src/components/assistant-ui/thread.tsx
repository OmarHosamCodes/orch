    ...
    >
      ...
      <ActionBarMorePrimitive.Root>
        ...
        <ActionBarMorePrimitive.Content
          ...
          align="start"
          sideOffset={6}
          className="aui-action-bar-more-content bg-popover text-popover-foreground data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=closed]:animate-out data-[side=bottom]:slide-in-from-top-1 data-[side=top]:slide-in-from-bottom-1 z-50 w-56 max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-surface border border-border p-1 shadow-lg motion-reduce:animate-none"
        >
